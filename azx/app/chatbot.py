...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            with gr.Row():
                cold_weather_button = gr.Button(ask_cold_weather_question, label="Ask about Cold Weather")
                desert_button = gr.Button(ask_desert_question, label="Ask about the Desert")
